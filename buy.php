...
if(isset($price_obj)){
	...
	if($price_obj->getToolDel($tool['tid'])==1)sysmsg('商品维护中');
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $cdnserver; ?>assets/store/css/detail.css?ver=1.0.1">
...
<div class="fui-page-group statusbar" style="max-width: 650px;left: auto;">
    <div class="fui-page  fui-page-current " style="overflow: inherit">
                ...
                <div class="list_item_box" style="top: 53px;">
                    <div class="bor_detail">
                        ...
                        <div class="pro_right fl">
                            ...
                            <a href="../" class="icon icon-home color"
                               style="float: right;margin-right: 1em;background-color: #0079fa;color: white;padding: 0.3rem;border-radius: 3em;box-shadow: 3px 3px 6px #eee;"></a>
                            ...
                            <div class="list_tag">
                                <div class="price">
                                    <span class="t_price pay_prices">售价：<span class="pay_price"><?php echo $price?>元 x1</span>
       ...
       <div style="width:100%;text-align:center;font-size:17px;font-weight:550;">下单信息填写</div>
			
			<div style="padding:10px;">
			    <div id="fenshu" class="layui-form-item" <?php echo $tool['multi']==0?'style="display: none"':null;?>>
                    <label class="layui-form-label" style="width: 100%;text-align: left;padding:0">下单数量：<?php if($isfaka == 1){echo "<span style='float:right;'>剩余：<font color='red'>".$count."</font>份</span>";} ?></label>
                    <div class="input-group" style="width:70%;text-align:center;">
                        <div class="input-group-addon" id="num_min" style="background-color: #FBFBFB;border-radius: 2px 0 0 2px;cursor: pointer;">减一份</div>
                        ...
                        <div class="input-group-addon" id="num_add" style="background-color: #FBFBFB;border-radius: 2px 0 0 2px;cursor: pointer;">加一份</div>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-">
                        <b><input  style="text-align: center;color:#4169E1;" type="text" id="need" disabled class="form-control" value="<?php echo $price?> 元"></b>
                    </div>
                </div>
                <div id="matching_msg"
    ...
    <!--<div id="oneshop" class="aui-footer-button aui-footer-flex aui-footer-fixed" style="display: flex;    align-items: flex-start;">-->
        <div class="assemble-footer footer" style="<?php if(strpos($_SERVER['HTTP_USER_AGENT'],'QQ/')!==false){?>height: 110px;padding-bottom: 55px;<?php }?>">
            ...
            <div class="aui-footer-wrap" style="<?php if($conf['shoppingcart']==0){?>display:none;<?php }?>">
            ...
            <div class="aui-footer-group aui-footer-flex1">
                <div class="aui-footer-flex">
                    <div class="aui-btn aui-btn-red" id="submit_buy">
                        <span >立即购买</span>
                    </div>
                </div>
            </div>
...
<script src="assets/store/js/main.js?ver=1.0.0"></script>
<script>

setTimeout(function() {
     layer.tips('请输入<?php echo $tool['input']?>', '#inputvalue', {
  tips: [3, '#black']
});
}, 500);
</script>
<script>
    $(function(){
        layer.photos({
            ...
            anim: 5 // 设置放大图片的动画效果，这里使用了缩放放大的效果（anim: 5）
        });
    });
</script>
</body>
